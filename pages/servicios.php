...
<head>
    ...
    <link rel="stylesheet" href="../styles/servicios/servicios.css">
...
<?php include "../templates/menu.php"; ?>
    ...
    <script src="../scripts/particleServicios.js"></script>
    <script>
        function resizeParticlesJs() {
            const particlesJs = document.getElementById('particles-js');            
            particlesJs.style.height = `${document.documentElement.scrollHeight-20}px`;
        }

        window.addEventListener('resize', resizeParticlesJs);
        window.addEventListener('load', resizeParticlesJs);
