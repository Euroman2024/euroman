...
if (isset($_POST['agregar_subcategoria'])) {
    ...
    $sql = "INSERT INTO subcategorias (nombre_subcategoria, categoria_id) VALUES ('$nombre_subcategoria', $categoria_id)";
    $conexion->query($sql);
}
...
if (isset($_POST['agregar_repuesto'])) {
    ...
    $sql = "INSERT INTO repuestos (nombre_repuesto, descripcion, precio, subcategoria_id";
...
if (isset($_POST['eliminar_repuesto'])) {
    ...
    $sql = "DELETE FROM repuestos WHERE repuesto_id = $repuesto_id";
...
if (isset($_POST['modificar_categoria'])) {
    ...
    $sql = "UPDATE categorias SET nombre_categoria = '$nuevo_nombre_categoria' WHERE categoria_id = $categoria_id_modificar";
    if ($conexion->query($sql) === TRUE) {
...
if (isset($_POST['modificar_subcategoria'])) {
    ...
    $sql = "UPDATE subcategorias SET nombre_subcategoria = '$nuevo_nombre_subcategoria' WHERE subcategoria_id = $subcategoria_id_modificar";
    if ($conexion->query($sql) === TRUE) {
...
if (isset($_POST['modificar_repuesto'])) {
    ...
    $sql = "UPDATE repuestos SET nombre_repuesto = ?, descripcion = ?, precio = ? WHERE repuesto_id = ?";
    $statement = $conexion->prepare($sql);
...
if (isset($_POST['modificar_imagen_repuesto'])) {
    ...
    if ($_FILES["nueva_imagen"]["error"] == UPLOAD_ERR_OK) {
        ...
        $sql = "UPDATE repuestos SET imagen1 = ? WHERE repuesto_id = ?";
        $statement = $conexion->prepare($sql);
...
if (isset($_POST['modificar_categoria_subcategoria'])) {
    ...
    $sql = "UPDATE subcategorias SET categoria_id = $nueva_categoria_id WHERE subcategoria_id = $subcategoria_id_modificar_categoria";
    if ($conexion->query($sql) === TRUE) {
    ...
    <div class="contenido1">
        ...
        <form method="POST">
            ...
            <select name="categoria_id">
                <?php
                // Obtener categorías
                $categorias_result = $conexion->query("SELECT * FROM categorias");
        ...
        <form class="agR" method="POST" enctype="multipart/form-data">
            ...
            <select name="subcategoria_id">
                ...
                $subcategorias_result = $conexion->query("SELECT * FROM subcategorias");
        ...
        <form method="POST">
            <select name="repuesto_id">
                <?php 
                // Obtener repuestos
                $repuestos_result = $conexion->query("SELECT * FROM repuestos");
